												...
												<fieldset>
													...
													<div class="clearfix">
														<label class="inline">
															...
															<span> <input class="lbl" type="checkbox" name="remenber" /> 自动登录</span>
														</label>
								...
								<div id="signup-box" class="signup-box widget-box no-border">
									...
									<% if(reg_res!=null && reg_res.equals("1")) 
										...
										<div class="widget-main">
											...
											<form id="regiester" method="post" action="servlet/RegisterServlet">
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input name="password2" type="password" class="form-control" placeholder="确认密码" />
